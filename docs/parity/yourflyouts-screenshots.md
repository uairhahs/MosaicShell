...
Canonical gallery: [YourFlyouts screenshots](https://github.com/Jax-Core/YourFlyouts/blob/main/Screenshots.md).

Use the upstream gallery for static layout references. MosaicShell's signed-off static
layouts are published in [the Tessera proof gallery](../../.github/res/Tessera/).
