...
| 5                 | `TesseraStackedPlacementPolicy`   | `ResolveLayoutKind`, `SupportsStackedOsAcrylic`, `ComputePlacements`, `VerticalGapForStyle`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 6                 | `TesseraOsAcrylicStackedPolicy`   | `ResolvePanelCornerRadiusDip`, `IsCoreUiMultiTile`, `UseMultiWindow`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 7                 | `TesseraOsAcrylicSignOffPolicy`   | `H3StackedStylesSignedOff` — **confirm first**, may be a deliberate manual QA gate (see Exceptions)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 8                 | `TesseraStatusFlyoutPolicy`       | `ResolveChipCornerRadiusDip` — not yet folded in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
