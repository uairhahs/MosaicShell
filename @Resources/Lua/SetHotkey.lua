...
function Set(hotkey, useWin, repHotkeyIndex)
    if hotkey ~= nil then
        ...
        SKIN:Bang('[!WriteKeyvalue Variables Key' .. SecNum .. ' "' .. hotkey .. '" "' .. saveLocation .. '"][!WriteKeyvalue Variables Key' .. SecNum .. 'InString "' .. hotkeyString .. '" "' .. saveLocation .. '"][!UpdateMeasure Auto_Refresh:M "#MosaicShell\\Main"][!Refresh "#MosaicShell\\Main"]')
    end
