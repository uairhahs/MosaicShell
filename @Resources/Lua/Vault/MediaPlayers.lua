...
function startInfo(playerShape)
	...
	SKIN:Bang('!Activateconfig', '#MosaicShell\\Accessories\\MediaDetails')
	SKIN:Bang('!Move', PosX, PosY, '#MosaicShell\\Accessories\\MediaDetails')
end
...
function changeTo()
    ...
    SKIN:Bang('!Refresh', '#MosaicShell\\Main')
    SKIN:Bang('!UpdateMeasure', 'Auto_Refresh:M', '#MosaicShell\\Main')
