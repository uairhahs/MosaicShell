...
function Start(section)
    ...
    local location = location .. '\\#MosaicShell\\Accessories\\Combilaunch\\Main.ini'
    ...
    SKIN:Bang('!ActivateConfig', '#MosaicShell\\Accessories\\Combilaunch')
    SKIN:Bang('!Move', mX, mY, '#MosaicShell\\Accessories\\Combilaunch')
    return
end