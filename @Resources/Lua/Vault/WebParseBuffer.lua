function start()
	...
	SKIN:Bang('!Activateconfig', '#MosaicShell\\Accessories\\WebParse')
	SKIN:Bang('!Move', PosX, PosY, '#MosaicShell\\Accessories\\WebParse')
end

function stop()
	SKIN:Bang('!DeactivateConfig', '#MosaicShell\\Accessories\\WebParse')
end