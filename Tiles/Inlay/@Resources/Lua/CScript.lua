...
function Draw() -- Sets all meter properties and calculates days
	...
	for MeterNumber = 1, Range[Settings.Range].days do
		...
		local MeterProperties = {
			...
			[Settings.EventColor or 'Font_Color'] = EventColor or '',
		}
...
function Shunbun()
    return os.time{month = 3, day = math.floor(20.8431 + 0.242194 * (Time.show.year - 1980) - math.floor((Time.show.year - 1980) / 4)), year = Time.show.year}
end
 
function Shuubun()
    return os.time{month = 9, day = math.floor(23.2488 + 0.242194 * (Time.show.year - 1980) - math.floor((Time.show.year - 1980) / 4)), year = Time.show.year}
end
