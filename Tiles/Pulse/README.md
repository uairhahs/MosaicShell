...
<br />
<div align="center">
  <a href="https://github.com/uairhahs/Pulse">
    <img src="https://raw.githubusercontent.com/uairhahs/ReadME-Template/main/Resources/Icons/Pulse.png" alt="Logo" width="180" height="180">
  </a>
...
<p align="center">
  <img alt="Latest by date" src="https://img.shields.io/github/v/tag/Jax-Core/Pulse?label=Version&style=for-the-badge" />
  <img alt="Discord" src="https://img.shields.io/discord/880445067754610688?label=Discord%20server&style=for-the-badge" />
  <img alt="Github" src="https://img.shields.io/github/license/Jax-Core/Pulse?style=for-the-badge" />
...
![Pulse](https://raw.githubusercontent.com/uairhahs/ReadME-Template/main/Resources/Splash/Pulse.png)

<!-- END About.mustache -->
**Pulse** is a highly customizable audio visualizer that includes a plethora of pre-built layouts and over 40+ options to experiment with, as well as an additional 3D overlay module for creating layering effects. This bad boy does a lot more than what the screenshot shows.
...
After you've proceeded through the welcome screen, select `Pulse` (might have to scroll down) and click `Install`. It will appear in the library page after that.
<br />
<br />
...
### Configuration
Use the MosaicShell menu to configure Pulse.
...
* or [Create an issue](https://github.com/uairhahs/Pulse)
