<br />
<div align="center">
  <a href="https://github.com/uairhahs/Substrate">
    <img src="https://imgur.com/MhwrA7U.png" alt="Logo" width="384" height="192">
  </a>

<h3 align="center">Substrate</h3>

  <p align="center">
    A PC-based version of an Android control center.
    <br />
    <a href="https://www.deviantart.com/mosaicshell/art/Substrate-v2-0-885183361"><strong>More Info »</strong></a>
    <br />
    <br />
...
Substrate is a Rainmeter skin that brings the Android control center to Windows. Substrate includes 2 different color schemes as well as multiple customization options for you to tweak and customize to your liking. **See the video linked above.**
...
- **MosaicShell v40005 or newer.** MosaicShell can be installed by downloading the `.rmskin` file from [MosaicShell's official website.](https://jax-core.github.io/)

### Installation

Assuming you successfully downloaded and installed Rainmeter as well as MosaicShell, you can now proceed to install Substrate by following the steps below.

1. Download and run the `.rmskin` file for **Substrate** from the official [MosaicShell site](https://jax-core.github.io/) to install **Substrate**.
2. Leave the installation settings at their defaults and click Install.
3. When the installation is finished, a startup pop-up should appear. Follow through the pop-up to finish installing Substrate.

- Note: If you find that the MosaicShell option is red on the startup pop-up, please press the red button and Core will be installed automatically. Perchance this fails, you can manually install Core by downloading the `.rmskin` file from [MosaicShell's official website.](https://jax-core.github.io/)

### Customization

Substrate includes 2 color scheme presets. You enable them by just selecting them within the **Appearance** tab. These are their names:
...
Now that you've installed and setup Substrate, let's begin setting up some modules it comes with!
...
2. Select **Substrate** from the list and proceed to the **Media** tab.
...
5. Refresh Substrate and your media controls for Spotify should work.
...
5. Refresh Substrate and your media controls for any website should work.
...
1. Open Core and head over to the **Modules** section.
2. Select **Substrate** from the list and proceed to the **General** tab.
3. Under **Time & Weather**, change `Weather Location` to the location you want the weather status for.
4. Refresh Substrate and your weather status should work.
