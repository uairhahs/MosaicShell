function check()
    ...
    elseif ParsedVer <= CoreVer then
        ...
        SKIN:Bang('!WriteKeyValue', 'Data', 'DownloadLink', 'https://github.com/EnhancedJax/-MosaicShell/releases/download/v'..ParsedVerFull..'/MosaicShell_v'..ParsedVerFull..'.rmskin', SavePos)
