...
namespace MosaicShell.Core.Tests
{
    ...
    public class TesseraAlbumArtRegressionTests
    {
        ...
        public void Wnp_tiny_png_fixture_meets_apply_art_length_contract()
        {
            ...
            _ = WebNowPlayingHostTests.TinyPng.Length.Should().BeGreaterThanOrEqualTo(32);
            _ = CompositeMediaSessionService.IsUsableCover(WebNowPlayingHostTests.TinyPng).Should().BeTrue();
        }
        ...
        public void Merge_puts_wnp_tiny_png_on_media_session_for_browser()
        {
            ...
            _ = merged.ThumbnailPng.Should().BeSameAs(WebNowPlayingHostTests.TinyPng);
