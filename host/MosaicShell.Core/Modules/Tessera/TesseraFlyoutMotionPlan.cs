namespace MosaicShell.Core.Modules.Tessera
{
    ...
    public sealed class TesseraFlyoutMotionPlan
    {
        ...
        {
            return HostMustPumpSharedPhase2Progress
        ...
        {
            List<TesseraFlyoutMotionStepKind> kinds = [];
        ...
        private static TesseraFlyoutMotionPlan Build(
            ...
            bool clusterFlag)
        {
            bool clustered = stacked && MotionPlanMustClusterStackedSlots && clusterFlag;
            TesseraFlyoutMotionSlotFilter phase1Filter = clustered
                ? TesseraFlyoutMotionSlotFilter.Phase1Slots
                : TesseraFlyoutMotionSlotFilter.All;
            TesseraFlyoutMotionSlotFilter phase2Filter = clustered
                ? TesseraFlyoutMotionSlotFilter.Phase2Slots
                : TesseraFlyoutMotionSlotFilter.All;
            bool runPhase2 = TesseraFlyoutAnimationPolicy.Phase2RequiresAnimatedLayout(
                ani, styleId, showMediaStrip);

            List<TesseraFlyoutMotionStep> steps =
            [
