namespace MosaicShell.Core.Modules.Tessera
{
    ...
    public static class TesseraFlyoutGlassPolicy
    {
        ...
        {
            return ShouldUseEmbeddedPreviewBuild(isConfigOrExportPreview, TesseraFlyoutWindowPolicy.SoftFrostHwndReady);
        }

        public static bool ShouldUseEmbeddedPreviewBuild(bool isConfigOrExportPreview, bool softFrostHwndReady)
        {
            return (isConfigOrExportPreview && PreviewMayUseEmbeddedSimple) || (!softFrostHwndReady && PreferPresentableShellUntilSoftFrostHwnd);
        }

        public static bool ShouldEnableBackdropBlur(bool softFrostHwndReady, bool settingsWantBlur)
        {
            return softFrostHwndReady
            && settingsWantBlur
        ...
        {
            return softFrostHwndReady && settingsWantBlur;
        }

        public static bool ShouldAllowGdiScreenCapture(bool softFrostHwndReady, bool settingsWantBlur)
        {
            return ShouldEnableBackdropBlur(softFrostHwndReady, settingsWantBlur)
            && !ForbidLiveBackdropPixelSampling;
        }

        public static TesseraFlyoutGlassMode ResolveLiveMode(bool softFrostHwndReady, bool useBackdropBlur)
        {
            return ResolveLiveMode(softFrostHwndReady, useBackdropBlur, osAcrylicEligible: false);
        }
        ...
        {
            return !softFrostHwndReady && PreferPresentableShellUntilSoftFrostHwnd
                ? TesseraFlyoutGlassMode.EmbeddedSimple
                : osAcrylicEligible
                ? TesseraFlyoutGlassMode.OsAcrylic
                : ShouldEnableBackdropBlur(softFrostHwndReady, useBackdropBlur)
                ? TesseraFlyoutGlassMode.SkiaBackdrop
                : TesseraFlyoutGlassMode.SkiaFallback;
        }
        ...
        {
            return mode is TesseraFlyoutGlassMode.SkiaFallback
