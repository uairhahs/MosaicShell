...
namespace MosaicShell.Core.Modules.Tessera
{
    ...
    public static class TesseraStatusFlyoutPolicy
    {
        ...
        /// <summary>
        /// Tessera-facing alias for <see cref="MediaFlyoutRouter.IsStatusKind"/> (platform owns the
        /// classification, so the media router and Tessera cannot disagree about what a chip is).
        /// </summary>
        public static bool IsStatusKind(string? kind)
        {
            return MediaFlyoutRouter.IsStatusKind(kind);
        }
        ...
        /// </summary>
        public static bool MustUseDedicatedSingleWindow(string? kind)
        {
            return IsStatusKind(kind);
        }
        ...
        {
            return MustRecreateHwndAfterMediaShell
        ...
        {
            return widthDip > ChipMaxWidthDip || heightDip > ChipMaxHeightDip;
        }
            ...
            double desiredHeight)
        {
            ...
            double w = desiredWidth > 1 ? desiredWidth : boundsWidth;
            double h = desiredHeight > 1 ? desiredHeight : boundsHeight;
            if (w < 1)
            {
