namespace MosaicShell.Core.Modules.Tessera
{
    ...
    public static class TesseraFlyoutWindowPolicy
    {
        ...
        {
            return MustRequestOpaqueToolWindow ? ["None"] : material.TransparencyHints;
        }
        ...
        {
            byte alpha = material.ShellAlpha;
        ...
        // material is unused only while SoftFrostHwndReady is true; the else branch is the
        // opaque-recovery path and needs it if that flag is ever flipped back off.
...
#pragma warning restore IDE0060
        ...
        {
            return widthDip >= ResolveRelayoutMinWidthDip(stackedClusterPanel)
