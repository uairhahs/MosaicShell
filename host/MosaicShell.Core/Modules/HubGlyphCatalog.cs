namespace MosaicShell.Core.Modules
{
    ...
    {
        public static HubGlyph ForModule(string moduleId)
        {
            return moduleId?.Trim().ToLowerInvariant() switch
            {
        ...
        public static HubGlyph ForHomeCard(string targetPage)
        {
            return targetPage?.Trim() switch
            {
