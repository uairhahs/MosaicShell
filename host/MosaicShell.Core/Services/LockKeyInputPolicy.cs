namespace MosaicShell.Core.Services
{
    ...
    public static class LockKeyInputPolicy
    {
        ...
        {
            return vk is VkCapital or VkNumlock or VkScroll;
        }

        public static bool IsKeyboardMessage(int msg)
        {
            return msg is WmKeydown or WmKeyup or WmSyskeydown or WmSyskeyup;
        }
        ...
        {
            return nCode >= 0 && IsKeyboardMessage(msg) && IsToggleVirtualKey(vk);
        }
        ...
        {
            return msg is WmKeydown or WmSyskeydown;
        }

        /// <summary>Low bit of GetKeyState / keyboard state for Caps/Num/Scroll = toggled on.</summary>
        public static bool IsToggleBitOn(short keyState)
        {
            return (keyState & 1) != 0;
        }

        public static LockKeyKind? KindFromVirtualKey(int vk)
        {
            return vk switch
            {
