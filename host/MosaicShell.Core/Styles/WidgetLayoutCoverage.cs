namespace MosaicShell.Core.Styles
{
    public static class ChronoLayoutCoverage
    {
        ...
        public static bool IsFlagship(string styleId)
        {
            return Flagship.Contains(StyleIds.Normalize(styleId));
        }

        public static bool IsChromeOnly(string styleId)
        {
            return ChromeOnly.Contains(StyleIds.Normalize(styleId));
        }

        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Chrono").All(id => Flagship.Contains(id) || ChromeOnly.Contains(id));
        }
    }
    ...
    public static class PhonoLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Phono").All(id => Flagship.Contains(id) || Distinct.Contains(id) || ChromeOnly.Contains(id));
        }
    }
    ...
    public static class PulseLayoutCoverage
    {
        ...
        public static bool IsFlagship(string styleId)
        {
            return Flagship.Contains(styleId);
        }

        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Pulse").All(id => Flagship.Contains(id) || Variant.Contains(id));
        }
    }
    ...
    public static class CanvasLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Canvas").All(id => Flagship.Contains(id) || Variant.Contains(id));
        }
    }
    ...
    public static class MixdeckLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Mixdeck").All(id => Flagship.Contains(id) || Chrome.Contains(id));
        }
    }
    ...
    public static class InlayLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Inlay").All(id => Flagship.Contains(id) || Chrome.Contains(id));
        }
    }
    ...
    public static class ChordLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Chord").All(Distinct.Contains);
        }
    }
    ...
    public static class SubstrateLayoutCoverage
    {
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Substrate").Contains("DEFAULT", StringComparer.OrdinalIgnoreCase);
        }
    }
    ...
    public static class SlateLayoutCoverage
    {
        ...
        public static bool CoversCatalog()
        {
            return StyleCatalog.IdsFor("Slate").All(id => Implemented.Contains(id) || Deferred.Contains(id));
        }
    }
}
