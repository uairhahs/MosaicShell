...
namespace MosaicShell.Host.Tiles.Tessera
{
    ...
    public sealed class TesseraEasePreview : UserControl
    {
        ...
        {
            _ = AniEaseProperty.Changed.AddClassHandler<TesseraEasePreview>((p, _) => p.Replay());
            _ = AniStepsProperty.Changed.AddClassHandler<TesseraEasePreview>((p, _) => p.Replay());
        }
        ...
        {
            double from = TesseraEasePreviewSpec.OvershootPadDip;
            double to = from + TesseraEasePreviewSpec.TravelDip;
